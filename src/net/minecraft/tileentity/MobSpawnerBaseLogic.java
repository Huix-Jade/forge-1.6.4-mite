...
public abstract class MobSpawnerBaseLogic {
   ...
   public boolean canRun() {
      return this.getSpawnerWorld().getClosestPlayer((double)this.getSpawnerX() + 0.5, (double)this.getSpawnerY() + 0.5, (double)this.getSpawnerZ() + 0.5, (double)this.activatingRangeFromPlayer, true) != null;
   }
      ...
      if (this.canRun()) {
         ...
         if (this.getSpawnerWorld().isRemote) {
            ...
            while(true) {
               ...
               int var4 = this.getSpawnerWorld().getEntitiesWithinAABB(var13.getClass(), AxisAlignedBB.getAABBPool().getAABB((double)this.getSpawnerX(), (double)this.getSpawnerY(), (double)this.getSpawnerZ(), (double)(this.getSpawnerX() + 1), (double)(this.getSpawnerY() + 1), (double)(this.getSpawnerZ() + 1)).expand((double)(this.spawnRange * 2), 4.0, (double)(this.spawnRange * 2))).size();
               ...
               if (var11 != null) {
                  ...
                  if (this instanceof TileEntityMobSpawnerLogic) {
