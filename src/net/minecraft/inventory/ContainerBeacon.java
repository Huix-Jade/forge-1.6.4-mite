   ...
   public ContainerBeacon(EntityPlayer player, TileEntityBeacon par2TileEntityBeacon) {
      ...
      for(var5 = 0; var5 < 3; ++var5) {
         for(int var6 = 0; var6 < 9; ++var6) {
            this.addSlotToContainer(new Slot(player.inventory, var6 + var5 * 9 + 9, var3 + var6 * 18, var4 + var5 * 18));
         }
      }

      for(var5 = 0; var5 < 9; ++var5) {
         this.addSlotToContainer(new Slot(player.inventory, var5, var3 + var5 * 18, 58 + var4));
      }
