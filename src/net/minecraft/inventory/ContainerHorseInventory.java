   ...
   public ContainerHorseInventory(EntityPlayer player, IInventory par2IInventory, EntityHorse par3EntityHorse) {
      ...
      for(var6 = 0; var6 < 3; ++var6) {
         for(var7 = 0; var7 < 9; ++var7) {
            this.addSlotToContainer(new Slot(player.inventory, var7 + var6 * 9 + 9, 8 + var7 * 18, 102 + var6 * 18 + var5));
         }
      }

      for(var6 = 0; var6 < 9; ++var6) {
         this.addSlotToContainer(new Slot(player.inventory, var6, 8 + var6 * 18, 160 + var5));
      }
