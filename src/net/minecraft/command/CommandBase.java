...
public abstract class CommandBase implements ICommand {
   ...
   public static double func_110661_a(ICommandSender par0ICommandSender, String par1Str, double par2, double par4) {
      ...
      if (var6 < par2) {
         throw new NumberInvalidException("commands.generic.double.tooSmall", new Object[]{var6, par2});
      } else if (var6 > par4) {
         throw new NumberInvalidException("commands.generic.double.tooBig", new Object[]{var6, par4});
      } else {
         return var6;
      }
   }
   ...
   public static double func_110666_a(ICommandSender par0ICommandSender, double par1, String par3Str, int min_xz, int max_xz) {
      return func_110665_a(par0ICommandSender, par1, par3Str, min_xz, max_xz);
   }
   ...
   public static double func_110665_a(ICommandSender par0ICommandSender, double par1, String par3Str, int par4, int par5) {
      ...
      if (var6 && Double.isNaN(par1)) {
         throw new NumberInvalidException("commands.generic.num.invalid", new Object[]{par1});
      } else {
         double var7 = var6 ? par1 : 0.0;
         ...
         if (par4 != 0 || par5 != 0) {
            if (var7 < (double)par4) {
               throw new NumberInvalidException("commands.generic.double.tooSmall", new Object[]{var7, par4});
            }

            if (var7 > (double)par5) {
               throw new NumberInvalidException("commands.generic.double.tooBig", new Object[]{var7, par5});
            }
         }
