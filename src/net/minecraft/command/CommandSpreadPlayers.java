...
public class CommandSpreadPlayers extends CommandBase {
   ...
   public void processCommand(ICommandSender par1ICommandSender, String[] par2ArrayOfStr) {
      if (par2ArrayOfStr.length < 6) {
         ...
         int var17 = var3 + 1;
         ++var17;
         double var8 = func_110664_a(par1ICommandSender, par2ArrayOfStr[var17++], 0.0);
         double var10 = func_110664_a(par1ICommandSender, par2ArrayOfStr[var17++], var8 + 1.0);
         ...
         while(true) {
            ...
            EntityPlayerMP player = (EntityPlayerMP)var13.get(0);
            World world = player.worldObj;
            double var4 = func_110666_a(par1ICommandSender, Double.NaN, par2ArrayOfStr[0], MathHelper.floor_double(world.min_entity_pos_xz), MathHelper.floor_double(world.max_entity_pos_xz));
            double var6 = func_110666_a(par1ICommandSender, Double.NaN, par2ArrayOfStr[1], MathHelper.floor_double(world.min_entity_pos_xz), MathHelper.floor_double(world.max_entity_pos_xz));
            par1ICommandSender.sendChatToPlayer(ChatMessageComponent.createFromTranslationWithSubstitutions("commands.spreadplayers.spreading." + (var12 ? "teams" : "players"), func_110663_b(var13), var4, var6, var8, var10));
   ...
   private void func_110669_a(ICommandSender par1ICommandSender, List par2List, CommandSpreadPlayersPosition par3CommandSpreadPlayersPosition, double par4, double par6, World par8World, boolean par9) {
      ...
      notifyAdmins(par1ICommandSender, "commands.spreadplayers.success." + (par9 ? "teams" : "players"), new Object[]{var19.length, par3CommandSpreadPlayersPosition.field_111101_a, par3CommandSpreadPlayersPosition.field_111100_b});
      if (var19.length > 1) {
         par1ICommandSender.sendChatToPlayer(ChatMessageComponent.createFromTranslationWithSubstitutions("commands.spreadplayers.info." + (par9 ? "teams" : "players"), String.format("%.2f", var21), var20));
      }
   ...
   private int func_110668_a(CommandSpreadPlayersPosition par1CommandSpreadPlayersPosition, double par2, World par4World, Random par5Random, double par6, double par8, double par10, double par12, CommandSpreadPlayersPosition[] par14ArrayOfCommandSpreadPlayersPosition, boolean par15) {
      ...
      if (var17 >= 10000) {
         throw new CommandException("commands.spreadplayers.failure." + (par15 ? "teams" : "players"), new Object[]{par14ArrayOfCommandSpreadPlayersPosition.length, par1CommandSpreadPlayersPosition.field_111101_a, par1CommandSpreadPlayersPosition.field_111100_b, String.format("%.2f", var18)});
      } else {
         return var17;
      }
   }
   ...
   private double func_110671_a(List par1List, World par2World, CommandSpreadPlayersPosition[] par3ArrayOfCommandSpreadPlayersPosition, boolean par4) {
      ...
      for(int var9 = 0; var9 < par1List.size(); ++var9) {
         ...
         var10.setPositionAndUpdate((double)((float)MathHelper.floor_double(var11.field_111101_a) + 0.5F), (double)var11.func_111092_a(par2World), (double)MathHelper.floor_double(var11.field_111100_b) + 0.5);
