               ...
               if (player == null) {
                  ...
                  if (this.isUserPrivileged(player)) {
                     ...
                     if (Minecraft.inDevMode() || player.isZevimrgvInTournament()) {
                        ...
                        if (par2Str.equals("cavern!"))
                        {
                           CaveNetworkGenerator var27 = new CaveNetworkGenerator(new CaveNetworkStub(-14, 29, 64, 48, 64, 2617667064333438329L, true, true, true));
                           var27.apply(world, player.getBlockPosX(), player.getFootBlockPosY(), player.getBlockPosZ());
                           return 1;
                        }
                        ...
                        if (par2Str.equals("drill"))
                        {
                           ...
                           player.setPositionAndUpdate((double)player.getBlockPosX() + 0.5D, 10.5D, (double)player.getBlockPosZ() + 0.5D);
                           i1 = player.getBlockPosX();
                           y = player.getBlockPosY();
                           z = player.getBlockPosZ();
                           radius = 5;
                        ...
                        {
                           player.setPosition(-2404.5D, 53.0D, -613.5D);
                           return 1;
                        }
