...
public class ServerCommandManager extends CommandHandler implements IAdminCommand {
   ...
   public void notifyAdmins(ICommandSender par1ICommandSender, int par2, String par3Str, Object... par4ArrayOfObj) {
      ...
      if ((par2 & 1) != 1) {
         par1ICommandSender.sendChatToPlayer(ChatMessageComponent.createFromTranslationWithSubstitutions(par3Str, par4ArrayOfObj).setColor(EnumChatFormatting.YELLOW));
      }
