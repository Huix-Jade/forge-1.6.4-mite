...
public class EntityTracker {
   ...
   public void func_85172_a(EntityPlayerMP par1EntityPlayerMP, Chunk par2Chunk) {
      ...
      while(var3.hasNext()) {
         EntityTrackerEntry var4 = (EntityTrackerEntry)var3.next();
         if (var4.myEntity != par1EntityPlayerMP && var4.myEntity.isAddedToAChunk()) {
            Chunk chunk = var4.myEntity.getChunkAddedTo();
            if (chunk.xPosition == par2Chunk.xPosition && chunk.zPosition == par2Chunk.zPosition) {
