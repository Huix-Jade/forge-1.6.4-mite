...
public abstract class EntityMinecartContainer extends EntityMinecart implements IInventory {
      ...
      for(int var2 = 0; var2 < this.getSizeInventory(); ++var2) {
         ...
         if (var3 != null) {
            ...
            while(var3.stackSize > 0) {
               ...
               var3.stackSize -= var7;
               EntityItem var8 = new EntityItem(this.worldObj, this.posX + (double)var4, this.posY + (double)var5, this.posZ + (double)var6, new ItemStack(var3.itemID, var7, var3.getItemSubtype()));
               if (var3.isItemDamaged()) {
                  var8.getEntityItem().setItemDamage(var3.getItemDamage());
               }
         ...
         for(int var1 = 0; var1 < this.getSizeInventory(); ++var1) {
            ...
            if (var2 != null) {
               ...
               while(var2.stackSize > 0) {
                  ...
                  var2.stackSize -= var6;
                  EntityItem var7 = new EntityItem(this.worldObj, this.posX + (double)var3, this.posY + (double)var4, this.posZ + (double)var5, new ItemStack(var2.itemID, var6, var2.getItemSubtype()));
                  if (var2.isItemDamaged()) {
                     var7.getEntityItem().setItemDamage(var2.getItemDamage());
                  }
   ...
   public void destroyInventory() {
      ItemStack[] item_stacks = this.minecartContainerItems;
