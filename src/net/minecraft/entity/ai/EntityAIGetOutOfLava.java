...
public class EntityAIGetOutOfLava extends EntityAIMovementTask {
   ...
   public boolean shouldExecute() {
      return !RNG.chance_in_16[++this.random_number_index & 32767] ? false : this.task_owner.handleLavaMovement();
   }
