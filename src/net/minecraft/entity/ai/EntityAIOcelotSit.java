...
public class EntityAIOcelotSit extends EntityAIBase {
   ...
   public void startExecuting() {
      this.theOcelot.getNavigator().tryMoveToXYZ((double)((float)this.sitableBlockX) + 0.5, (double)(this.sitableBlockY + 1), (double)((float)this.sitableBlockZ) + 0.5, this.field_75404_b);
      this.currentTick = 0;
   ...
   private boolean getNearbySitableBlockDistance() {
      ...
      for(int var4 = (int)this.theOcelot.posX - 8; (double)var4 < this.theOcelot.posX + 8.0; ++var4) {
         for(int var5 = (int)this.theOcelot.posZ - 8; (double)var5 < this.theOcelot.posZ + 8.0; ++var5) {
   ...
   private boolean isSittableBlock(World par1World, int par2, int par3, int par4) {
      ...
      if (var5 == Block.chest.blockID) {
         ...
         if (var5 > 0) {
            ...
            if (block instanceof BlockFurnace && ((BlockFurnace)block).isActive) {
               return true;
            }
         }
