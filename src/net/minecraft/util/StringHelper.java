...
public final class StringHelper {
   ...
   public static String formatFloat(float f, int min_num_decimal_places, int max_num_decimal_places) {
      if (min_num_decimal_places >= 0 && max_num_decimal_places >= 0) {
         if (min_num_decimal_places > max_num_decimal_places) {
            Minecraft.setErrorMessage("formatFloat: min_num_decimal_places > max_num_decimal_places");
         ...
         Minecraft.setErrorMessage("formatFloat: min_num_decimal_places or max_num_decimal_places is less than 0");
         return Float.toString(f);
      }
   }
   ...
   public static void addToStringArray(String s, String[] array) {
      ...
      Minecraft.setErrorMessage("addToStringArray: No room left in array");
   }
   ...
   public static String getRomanNumeral(int n) {
      if (n == 1) {
         ...
         Minecraft.setErrorMessage("getRomanNumeral: unhandled number " + n);
         return "?";
      }
   }
