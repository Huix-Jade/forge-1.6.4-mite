...
public class CombatTracker {
   ...
   public ChatMessageComponent func_94546_b() {
      if (this.field_94556_a.size() == 0) {
         return ChatMessageComponent.createFromTranslationWithSubstitutions("death.attack.generic", this.fighter.getTranslatedEntityName());
      } else {
         ...
         Entity var5 = var2.getDamageSrc().getResponsibleEntity();
         ...
         if (var1 != null && var2.getDamageSrc() == DamageSource.fall) {
            ...
            if (var1.getDamageSrc() != DamageSource.fall && var1.getDamageSrc() != DamageSource.outOfWorld) {
               if (var6 == null || var4 != null && var6.equals(var4)) {
                  if (var4 != null) {
                     ItemStack var7 = var5 instanceof EntityLivingBase ? ((EntityLivingBase)var5).getHeldItemStack() : null;
                     if (var7 != null && var7.hasDisplayName()) {
                        var3 = ChatMessageComponent.createFromTranslationWithSubstitutions("death.fell.finish.item", this.fighter.getTranslatedEntityName(), var4, var7.getDisplayName());
                     } else {
                        var3 = ChatMessageComponent.createFromTranslationWithSubstitutions("death.fell.finish", this.fighter.getTranslatedEntityName(), var4);
                     }
                  } else {
                     var3 = ChatMessageComponent.createFromTranslationWithSubstitutions("death.fell.killer", this.fighter.getTranslatedEntityName());
                  }
               } else {
                  Entity var9 = var1.getDamageSrc().getResponsibleEntity();
                  ItemStack var8 = var9 instanceof EntityLivingBase ? ((EntityLivingBase)var9).getHeldItemStack() : null;
                  if (var8 != null && var8.hasDisplayName()) {
                     var3 = ChatMessageComponent.createFromTranslationWithSubstitutions("death.fell.assist.item", this.fighter.getTranslatedEntityName(), var6, var8.getDisplayName());
                  } else {
                     var3 = ChatMessageComponent.createFromTranslationWithSubstitutions("death.fell.assist", this.fighter.getTranslatedEntityName(), var6);
                  }
               }
            } else {
               var3 = ChatMessageComponent.createFromTranslationWithSubstitutions("death.fell.accident." + this.func_94548_b(var1), this.fighter.getTranslatedEntityName());
            }
         } else {
      ...
      while(true) {
         ...
         do {
            do {
               ...
               if (var6.getDamageSrc().getResponsibleEntity() instanceof EntityPlayer && (var2 == null || var6.func_94563_c() > var4)) {
                  var4 = var6.func_94563_c();
                  var2 = (EntityPlayer)var6.getDamageSrc().getResponsibleEntity();
               }
            } while(!(var6.getDamageSrc().getResponsibleEntity() instanceof EntityLivingBase));
         } while(var1 != null && !(var6.func_94563_c() > var3));

         var3 = var6.func_94563_c();
         var1 = (EntityLivingBase)var6.getDamageSrc().getResponsibleEntity();
      }
   }
