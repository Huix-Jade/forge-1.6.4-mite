...
public class CombatEntry {
   ...
   public boolean func_94559_f() {
      return this.damageSrc.getResponsibleEntity() instanceof EntityLivingBase;
   }
   ...
   public String func_94558_h() {
      return this.getDamageSrc().getResponsibleEntity() == null ? null : this.getDamageSrc().getResponsibleEntity().getTranslatedEntityName();
   }
