...
public class BlockRailPowered extends BlockRailBase {
   ...
   public String getMetadataNotes() {
      return "0=Flat NS, 1=Flat EW, 2=Inclined East, 3=Inclined West, 4=Inclined North, 5=Inclined South, bit 8 set if powered";
   }
   ...
   public void addItemBlockMaterials(ItemBlock item_block) {
      item_block.addMaterial(new Material[]{Material.gold, Material.wood, Material.redstone});
   }
}
