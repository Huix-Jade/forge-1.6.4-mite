...
public final class BlockHardness {
   public static final float stone;
   public static final float grass;
   public static final float dirt;
   public static final float cobblestone = 1.5F;
   public static final float planks;
   public static final float sapling = 0.02F;
   public static final float sand;
   ...
   public static final float log;
   public static final float leaves;
   ...
   public static final float workbench;
   ...
   public static final float snow;
   public static final float blockIce;
   public static final float blockSnow;
   ...
   public static final float enchantmentTable;
   public static final float brewingStand;
   public static final float cauldron;
   public static final float whiteStone;
   ...
   public static final float anvil;
   ...
   public static final float hopperBlock;
   ...
   static {
      stone = Material.stone.getFullBlockHardness();
      grass = Material.dirt.getFullBlockHardness();
      dirt = Material.dirt.getFullBlockHardness();
      planks = Material.wood.getFullBlockHardness() * 2.0F / 3.0F;
      sand = Material.sand.getFullBlockHardness();
      log = Material.wood.getFullBlockHardness();
      leaves = Material.tree_leaves.getFullBlockHardness();
      workbench = planks * 2.0F;
      snow = Material.snow.getFullBlockHardness() / 8.0F;
      blockIce = log;
      blockSnow = Material.craftedSnow.getFullBlockHardness();
      enchantmentTable = workbench;
      brewingStand = workbench;
      cauldron = workbench;
      whiteStone = stone;
      anvil = workbench;
      hopperBlock = workbench;
   }
}
