...
public class RecipesMITE {
   ...
   public static void addCraftingRecipes(CraftingManager crafting_manager)
   {
      ...
      ItemBucket[] var7 = new ItemBucket[] {Item.bucketCopperWater, Item.bucketSilverWater, Item.bucketGoldWater, Item.bucketIronWater, Item.bucketAncientMetalWater, Item.bucketMithrilWater, Item.bucketAdamantiumWater};
      int i;
