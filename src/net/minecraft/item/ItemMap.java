...
public class ItemMap extends ItemMapBase {
   ...
   public MapData getMapData(ItemStack par1ItemStack, World par2World) {
      String var3 = "map_" + par1ItemStack.getItemSubtype();
      MapData var4 = (MapData)par2World.loadItemData(MapData.class, var3);
      if (var4 == null && !par2World.isRemote) {
         par1ItemStack.setItemSubtype(par2World.getUniqueDataId("map"));
         var3 = "map_" + par1ItemStack.getItemSubtype();
   ...
   public void updateMapData(World par1World, Entity par2Entity, MapData par3MapData) {
      if (par1World.provider.dimensionId == par3MapData.dimension && par2Entity instanceof EntityPlayer) {
         ...
         if (var12.field_82569_d >= 60 && !var12.world_map_survey_finished && par1World instanceof WorldServer) {
            var12.world_map_survey_finished = ((WorldServer)par1World).addWorldMapSurvey(par3MapData.xCenter, par3MapData.zCenter, 128, true) == 0;
         }
               ...
               for(int var18 = var10 - var11 - 1; var18 < var10 + var11; ++var18) {
                  if (var13 >= 0 && var18 >= -1 && var13 < var4 && var18 < var5) {
                     ...
                     if (!var25.isEmpty()) {
                              ...
                              for(var32 = 0; var32 < var6; ++var32) {
                                 ...
                                 if (var33 > 1) {
                                    ...
                                    do {
                                       ...
                                       if (var34 == 0) {
                                          var35 = false;
                                       } else if (var33 > 0 && var34 > 0 && Block.blocksList[var34].blockMaterial.map_color == MapColor.airColor) {
                                          var35 = false;
                                       }
                        ...
                        var36 = 0;
                        if (var32 > 0) {
                           MapColor var42 = Block.blocksList[var32].blockMaterial.map_color;
   ...
   public Packet createMapDataPacket(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) {
      ...
      return var4 == null ? null : new Packet131MapData((short)Item.map.itemID, (short)par1ItemStack.getItemSubtype(), var4);
   }
   ...
   public void onCreated(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) {
      if (par1ItemStack.hasTagCompound() && par1ItemStack.getTagCompound().getBoolean("map_is_scaling")) {
         ...
         par1ItemStack.setItemSubtype(par2World.getUniqueDataId("map"));
         MapData var5 = new MapData("map_" + par1ItemStack.getItemSubtype());
         ...
         var5.markDirty();
         par2World.setItemData("map_" + par1ItemStack.getItemSubtype(), var5);
         par1ItemStack.getTagCompound().removeTag("map_is_scaling");
      }

   }

   public static boolean isBeingExtended(ItemStack item_stack) {
      if (item_stack.getItem() != Item.map) {
         return false;
      } else {
         return !item_stack.hasTagCompound() ? false : item_stack.getTagCompound().getBoolean("map_is_scaling");
      }
   }
   ...
   public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4, Slot slot) {
      ...
      if (par4) {
         if (var5 == null) {
            ...
            par3List.add(Translator.getFormatted("item.tooltip.mapScaling", 1 << var5.scale + (isBeingExtended(par1ItemStack) ? 1 : 0)));
         }
      }
   ...
   public static boolean isAnotherMapIdAvailable(World world) {
      return world.peekUniqueDataId("map") <= 31999;
   }
}
