...
public class Village {
   ...
   public void addVillageDoorInfo(VillageDoorInfo par1VillageDoorInfo) {
      ...
      ChunkCoordinates var10000 = this.centerHelper;
      var10000.posX += par1VillageDoorInfo.posX;
      var10000 = this.centerHelper;
      var10000.posY += par1VillageDoorInfo.posY;
      var10000 = this.centerHelper;
      var10000.posZ += par1VillageDoorInfo.posZ;
   ...
   private void removeDeadAndOutOfRangeDoors() {
      ...
      while(true) {
         ...
         ChunkCoordinates var10000 = this.centerHelper;
         var10000.posX -= var4.posX;
         var10000 = this.centerHelper;
         var10000.posY -= var4.posY;
         var10000 = this.centerHelper;
         var10000.posZ -= var4.posZ;
         var1 = true;
