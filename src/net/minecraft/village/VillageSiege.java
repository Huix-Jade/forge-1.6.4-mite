...
public class VillageSiege {
            ...
            do {
               do {
                  do {
                     ...
                     } while(var3.isZevimrgvInTournament());
   ...
   private Vec3 func_75527_a(int par1, int par2, int par3) {
      for(int var4 = 0; var4 < 10; ++var4) {
         ...
         if (this.theVillage.isInRange(var5, var6, var7) && SpawnerAnimals.canCreatureTypeSpawnAtLocation(EnumCreatureType.monster, this.worldObj, var5, var6, var7, false, resulting_y_pos) && this.worldObj.isAirOrPassableBlock(var5, var6 + 1, var7, false)) {
            this.worldObj.getWorldVec3Pool().getVecFromPool((double)var5, resulting_y_pos[0], (double)var7);
            if (Minecraft.inDevMode()) {
               Minecraft.setErrorMessage("VillageSiege: tried to spawn zombie at " + var5 + "," + var6 + "," + var7);
            }
         }
      }
