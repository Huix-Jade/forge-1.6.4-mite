   ...
   public void updateMountedMovingPlayer(EntityPlayerMP par1EntityPlayerMP)
   {
      ...
      if (var8 >= 64.0D)
      {
         ...
         if (var13 != 0 || var14 != 0)
         {
            ...
            for (int var17 = var2 - var12; var17 <= var2 + var12; ++var17)
            {
               for (int var18 = var3 - var12; var18 <= var3 + var12; ++var18)
               {
                  if (!this.overlaps(var17, var18, var10, var11, var12))
                  {
                     this.getOrCreateChunkWatcher(var17, var18, true).addPlayer(par1EntityPlayerMP);
                  }

                  if (!this.overlaps(var17 - var13, var18 - var14, var2, var3, var12))
                  {
                     PlayerInstance var19 = this.getOrCreateChunkWatcher(var17 - var13, var18 - var14, false);

                     if (var19 != null)
                     {
                        var19.removePlayer(par1EntityPlayerMP);
                     }
                  }
               }
            }

            if (System.currentTimeMillis() - var15 > 10L)
            {
               System.out.println(par1EntityPlayerMP.worldObj.isRemote ? "[Client]" : "[Server] Long delay caught: " + (System.currentTimeMillis() - var15) + "ms");
            }
