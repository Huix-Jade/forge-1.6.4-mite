...
public class GuiScreenBook extends GuiScreen {
   ...
   public void initGui() {
      this.mc.sndManager.playSoundFX("imported.random.book_open", 0.5F, 1.0F);
      this.buttonList.clear();
      Keyboard.enableRepeatEvents(true);
      int var1;
      if (this.bookIsUnsigned) {
         var1 = this.width / 2;
         this.buttonList.add(this.buttonSign = new GuiButton(3, var1 - 91, 4 + this.bookImageHeight, 89, 20, I18n.getString("book.signButton")));
         this.buttonList.add(this.buttonDone = new GuiButton(0, var1 + 2, 4 + this.bookImageHeight, 89, 20, I18n.getString("gui.done")));
         this.buttonList.add(this.buttonFinalize = new GuiButton(5, var1 - 91, 4 + this.bookImageHeight, 89, 20, I18n.getString("book.finalizeButton")));
         this.buttonList.add(this.buttonCancel = new GuiButton(4, var1 + 2, 4 + this.bookImageHeight, 89, 20, I18n.getString("gui.cancel")));
      } else {
         this.buttonList.add(this.buttonDone = new GuiButton(0, this.width / 2 - 91, 4 + this.bookImageHeight, 182, 20, I18n.getString("gui.done")));
      }

      var1 = (this.width - this.bookImageWidth) / 2;
      byte var2 = 2;
   ...
   public void onGuiClosed() {
      ...
      this.mc.sndManager.playSoundFX("imported.random.book_close", 2.0F, 1.0F);
   }
   ...
   private void sendBookToServer(boolean par1) {
      if (!(this.itemstackBook.getItem() instanceof ItemReferencedBook)) {
   ...
   protected void actionPerformed(GuiButton par1GuiButton) {
      int previous_page = this.currPage;
      ...
      if (this.currPage != previous_page) {
         this.mc.sndManager.playSoundFX("imported.random.book_page", 0.5F, 1.0F);
      }
   ...
   public void drawScreen(int par1, int par2, float par3) {
      ...
      if (this.editingTitle) {
         ...
         String var10 = String.format(I18n.getString("book.byAuthor"), this.editingPlayer.getCommandSenderName());
         ...
         var6 = String.format(I18n.getString("book.pageIndicator"), this.currPage + 1, this.bookTotalPages);
         var7 = "";
         if (this.bookPages != null && this.currPage >= 0 && this.currPage < this.bookPages.tagCount()) {
