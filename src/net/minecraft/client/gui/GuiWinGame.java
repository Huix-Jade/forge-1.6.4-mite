...
public class GuiWinGame extends GuiScreen {
   ...
   public void initGui() {
      if (this.lines == null) {
         ...
         try {
            ...
            short var3 = 274;
            BufferedReader var4 = new BufferedReader(new InputStreamReader(this.mc.getResourceManager().getResource(new ResourceLocation("texts/profound.txt")).getInputStream(), Charsets.UTF_8));
            ...
            var4 = new BufferedReader(new InputStreamReader(this.mc.getResourceManager().getResource(new ResourceLocation("texts/end.txt")).getInputStream(), Charsets.UTF_8));
   ...
   private void func_73986_b(int par1, int par2, float par3) {
      ...
      var4.addVertexWithUV(0.0, (double)this.height, (double)this.zLevel, 0.0, (double)(var6 * var8));
      var4.addVertexWithUV((double)var5, (double)this.height, (double)this.zLevel, (double)((float)var5 * var8), (double)(var6 * var8));
      var4.addVertexWithUV((double)var5, 0.0, (double)this.zLevel, (double)((float)var5 * var8), (double)(var7 * var8));
      var4.addVertexWithUV(0.0, 0.0, (double)this.zLevel, 0.0, (double)(var7 * var8));
      var4.draw();
   }
   ...
   public void drawScreen(int par1, int par2, float par3) {
      ...
      var4.addVertexWithUV(0.0, (double)var13, (double)this.zLevel, 0.0, 1.0);
      var4.addVertexWithUV((double)var10, (double)var13, (double)this.zLevel, 1.0, 1.0);
      var4.addVertexWithUV((double)var10, 0.0, (double)this.zLevel, 1.0, 0.0);
      var4.addVertexWithUV(0.0, 0.0, (double)this.zLevel, 0.0, 0.0);
      var4.draw();
      GL11.glDisable(3042);
