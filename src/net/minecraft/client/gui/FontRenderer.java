   ...
   private void renderStringAtPos(String par1Str, boolean par2) {
      for(int var3 = 0; var3 < par1Str.length(); ++var3) {
         ...
         if (var4 == 167 && var3 + 1 < par1Str.length()) {
            EnumChatFormatting enum_chat_formatting = EnumChatFormatting.getByChar(par1Str.toLowerCase().charAt(var3 + 1));
            if (enum_chat_formatting == null) {
               enum_chat_formatting = EnumChatFormatting.WHITE;
            }

            if (enum_chat_formatting.isColor()) {
               this.randomStyle = false;
               this.boldStyle = false;
               this.strikethroughStyle = false;
               this.underlineStyle = false;
               ...
               if (Minecraft.theMinecraft.gameSettings.anaglyph) {
                  var6 = par2 ? enum_chat_formatting.rgb_anaglyph_shadow : enum_chat_formatting.rgb_anaglyph;
               } else {
                  var6 = par2 ? enum_chat_formatting.rgb_shadow : enum_chat_formatting.rgb;
               }

               this.textColor = var6;
               GL11.glColor4f((float)(var6 >> 16) / 255.0F, (float)(var6 >> 8 & 255) / 255.0F, (float)(var6 & 255) / 255.0F, this.alpha);
            } else if (enum_chat_formatting == EnumChatFormatting.OBFUSCATED) {
               this.randomStyle = true;
            } else if (enum_chat_formatting == EnumChatFormatting.BOLD) {
               this.boldStyle = true;
            } else if (enum_chat_formatting == EnumChatFormatting.STRIKETHROUGH) {
               this.strikethroughStyle = true;
            } else if (enum_chat_formatting == EnumChatFormatting.UNDERLINE) {
               this.underlineStyle = true;
            } else if (enum_chat_formatting == EnumChatFormatting.ITALIC) {
               this.italicStyle = true;
            } else if (enum_chat_formatting == EnumChatFormatting.RESET) {
               this.randomStyle = false;
               this.boldStyle = false;
               this.strikethroughStyle = false;
               this.underlineStyle = false;
            ...
            if (this.strikethroughStyle) {
               ...
               var9.addVertex((double)this.posX, (double)(this.posY + (float)(this.FONT_HEIGHT / 2)), 0.0);
               var9.addVertex((double)(this.posX + var8), (double)(this.posY + (float)(this.FONT_HEIGHT / 2)), 0.0);
               var9.addVertex((double)(this.posX + var8), (double)(this.posY + (float)(this.FONT_HEIGHT / 2) - 1.0F), 0.0);
               var9.addVertex((double)this.posX, (double)(this.posY + (float)(this.FONT_HEIGHT / 2) - 1.0F), 0.0);
               var9.draw();
               GL11.glEnable(3553);
            }
            ...
            if (this.underlineStyle) {
               ...
               var9.addVertex((double)(this.posX + (float)var10), (double)(this.posY + (float)this.FONT_HEIGHT), 0.0);
               var9.addVertex((double)(this.posX + var8), (double)(this.posY + (float)this.FONT_HEIGHT), 0.0);
               var9.addVertex((double)(this.posX + var8), (double)(this.posY + (float)this.FONT_HEIGHT - 1.0F), 0.0);
               var9.addVertex((double)(this.posX + (float)var10), (double)(this.posY + (float)this.FONT_HEIGHT - 1.0F), 0.0);
               var9.draw();
               GL11.glEnable(3553);
            }
