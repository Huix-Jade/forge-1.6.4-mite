...
class GuiSlotServer extends GuiSlot {
   ...
   protected void elementClicked(int par1, boolean par2) {
      if (par1 < GuiMultiplayer.getInternetServerList(this.parentGui).countServers() + GuiMultiplayer.getListOfLanServers(this.parentGui).size()) {
         ...
         if (this.parentGui instanceof GuiMultiplayer) {
            this.parentGui.updateButtonsForSelection();
            GuiMultiplayer var10000 = this.parentGui;
            GuiMultiplayer.loadServerImage(var4 != null && var4.image_url != null ? FilenameUtils.getName(var4.image_url) : null);
         }
