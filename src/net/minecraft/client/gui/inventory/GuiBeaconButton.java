...
class GuiBeaconButton extends GuiButton {
   ...
   protected GuiBeaconButton(int var1, int var2, int var3, ResourceLocation var4, int var5, int var6) {
   ...
   public void drawButton(Minecraft var1, int var2, int var3) {
      if (this.drawButton) {
         var1.getTextureManager().bindTexture(GuiBeacon.getBeaconGuiTextures());
         ...
         if (!GuiBeacon.getBeaconGuiTextures().equals(this.buttonTexture)) {
            var1.getTextureManager().bindTexture(this.buttonTexture);
         }
