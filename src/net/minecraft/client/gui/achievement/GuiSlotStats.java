...
abstract class GuiSlotStats extends GuiSlot {
   ...
   protected void func_77260_a(StatCrafting par1StatCrafting, int par2, int par3, boolean par4) {
      ...
      if (par1StatCrafting != null) {
         var5 = par1StatCrafting.func_75968_a((long)GuiStats.getStatsFileWriter(this.statsGui).writeStat(par1StatCrafting));
         if (GuiStats.this_world_only) {
            var5 = par1StatCrafting.func_75968_a(PlayerStatsHelper.getValueOnClient(par1StatCrafting.statId));
         }
