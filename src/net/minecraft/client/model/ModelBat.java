...
public class ModelBat extends ModelBase {
   ...
   public void render(Entity par1Entity, float par2, float par3, float par4, float par5, float par6, float par7) {
      ...
      float original_bat_head_offset_y = this.batHead.offsetY;
      float original_right_bat_wing_offset_y = this.batRightWing.offsetY;
      float original_left_bat_wing_offset_y = this.batLeftWing.offsetY;
      float var9;
      if (var8.getIsBatHanging()) {
         ModelRenderer var10000 = this.batHead;
         var10000.offsetY += 0.0625F;
         var10000 = this.batRightWing;
         var10000.offsetY -= 0.0625F;
         var10000 = this.batLeftWing;
         var10000.offsetY -= 0.0625F;
         var9 = 57.295776F;
      ...
      if (var8.getIsBatHanging()) {
         this.batHead.offsetY = original_bat_head_offset_y;
         this.batRightWing.offsetY = original_right_bat_wing_offset_y;
         this.batLeftWing.offsetY = original_left_bat_wing_offset_y;
      }
