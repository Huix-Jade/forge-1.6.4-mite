...
public class ModelHorse extends ModelBase {
   ...
   public void setLivingAnimations(EntityLivingBase var1, float var2, float var3, float var4) {
      ...
      this.frontLeftShin.rotationPointY = this.frontRightLeg.rotationPointY + MathHelper.sin(1.5707964F + var26) * 7.0F;
      this.frontLeftShin.rotationPointZ = this.frontRightLeg.rotationPointZ + MathHelper.cos(4.712389F + var26) * 7.0F;
      this.frontRightShin.rotationPointY = this.field_110684_D.rotationPointY + MathHelper.sin(1.5707964F + var27) * 7.0F;
      this.frontRightShin.rotationPointZ = this.field_110684_D.rotationPointZ + MathHelper.cos(4.712389F + var27) * 7.0F;
      ...
      this.frontLeftShin.rotateAngleX = (this.frontRightLeg.rotateAngleX + 3.1415927F * Math.max(0.0F, 0.2F + var25 * 0.2F)) * var12 + (var20 + Math.max(0.0F, var19 * 0.5F * var3)) * var13;
      this.frontLeftHoof.rotateAngleX = this.frontLeftShin.rotateAngleX;
      this.field_110684_D.rotateAngleX = var27;
      this.frontRightShin.rotateAngleX = (this.field_110684_D.rotateAngleX + 3.1415927F * Math.max(0.0F, 0.2F - var25 * 0.2F)) * var12 + (-var20 + Math.max(0.0F, -var19 * 0.5F * var3)) * var13;
