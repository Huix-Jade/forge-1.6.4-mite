...
public class SoundPool {
   ...
   private URL func_110654_c(String par1Str) throws MalformedURLException {
      ResourceLocation var2 = new ResourceLocation(par1Str, false);
      String var3 = String.format("%s:%s:%s/%s", "mcsounddomain", var2.getResourceDomain(), this.soundType, var2.getResourcePath());
