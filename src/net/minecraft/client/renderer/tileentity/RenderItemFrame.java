...
public class RenderItemFrame extends Render {
	...
	private void renderFrameItemAsBlock(EntityItemFrame par1EntityItemFrame) {
		...
		GL11.glPushMatrix();
		this.renderBlocksInstance.overrideBlockBounds(0.0, (double)(0.5F - var5 + 0.0625F), (double)(0.5F - var5 + 0.0625F), (double)(var3 * 0.5F), (double)(0.5F + var5 - 0.0625F), (double)(0.5F + var5 - 0.0625F));
		...
		GL11.glPushMatrix();
		this.renderBlocksInstance.overrideBlockBounds(0.0, (double)(0.5F - var5), (double)(0.5F - var5), (double)(var3 + 1.0E-4F), (double)(var3 + 0.5F - var5), (double)(0.5F + var5));
		this.renderBlocksInstance.renderBlockAsItem(var2, 0, 1.0F);
		GL11.glPopMatrix();
		GL11.glPushMatrix();
		this.renderBlocksInstance.overrideBlockBounds(0.0, (double)(0.5F + var5 - var3), (double)(0.5F - var5), (double)(var3 + 1.0E-4F), (double)(0.5F + var5), (double)(0.5F + var5));
		this.renderBlocksInstance.renderBlockAsItem(var2, 0, 1.0F);
		GL11.glPopMatrix();
		GL11.glPushMatrix();
		this.renderBlocksInstance.overrideBlockBounds(0.0, (double)(0.5F - var5), (double)(0.5F - var5), (double)var3, (double)(0.5F + var5), (double)(var3 + 0.5F - var5));
		this.renderBlocksInstance.renderBlockAsItem(var2, 0, 1.0F);
		GL11.glPopMatrix();
		GL11.glPushMatrix();
		this.renderBlocksInstance.overrideBlockBounds(0.0, (double)(0.5F - var5), (double)(0.5F + var5 - var3), (double)var3, (double)(0.5F + var5), (double)(0.5F + var5));
		this.renderBlocksInstance.renderBlockAsItem(var2, 0, 1.0F);
		GL11.glPopMatrix();
		this.renderBlocksInstance.unlockBlockBounds();
		this.renderBlocksInstance.clearOverrideBlockTexture();
	...
	private void func_82402_b(EntityItemFrame par1EntityItemFrame) {
		...
		if (var2 != null) {
			...
			if (var3.getEntityItem().getItem() == Item.map) {
				...
				byte var5 = 7;
				var4.addVertexWithUV((double)(0 - var5), (double)(128 + var5), 0.0, 0.0, 1.0);
				var4.addVertexWithUV((double)(128 + var5), (double)(128 + var5), 0.0, 1.0, 1.0);
				var4.addVertexWithUV((double)(128 + var5), (double)(0 - var5), 0.0, 1.0, 0.0);
				var4.addVertexWithUV((double)(0 - var5), (double)(0 - var5), 0.0, 0.0, 0.0);
				var4.draw();
