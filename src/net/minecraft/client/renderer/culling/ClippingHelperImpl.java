...
public final class ClippingHelperImpl extends ClippingHelper {
   ...
   private void init() {
      ...
      this.frustum_0_0 = this.frustum[0][0];
      this.frustum_0_1 = this.frustum[0][1];
      this.frustum_0_2 = this.frustum[0][2];
      this.frustum_0_3 = this.frustum[0][3];
      this.frustum_1_0 = this.frustum[1][0];
      this.frustum_1_1 = this.frustum[1][1];
      this.frustum_1_2 = this.frustum[1][2];
      this.frustum_1_3 = this.frustum[1][3];
      this.frustum_2_0 = this.frustum[2][0];
      this.frustum_2_1 = this.frustum[2][1];
      this.frustum_2_2 = this.frustum[2][2];
      this.frustum_2_3 = this.frustum[2][3];
      this.frustum_3_0 = this.frustum[3][0];
      this.frustum_3_1 = this.frustum[3][1];
      this.frustum_3_2 = this.frustum[3][2];
      this.frustum_3_3 = this.frustum[3][3];
      this.frustum_4_0 = this.frustum[4][0];
      this.frustum_4_1 = this.frustum[4][1];
      this.frustum_4_2 = this.frustum[4][2];
      this.frustum_4_3 = this.frustum[4][3];
      this.frustum_5_0 = this.frustum[5][0];
      this.frustum_5_1 = this.frustum[5][1];
      this.frustum_5_2 = this.frustum[5][2];
      this.frustum_5_3 = this.frustum[5][3];
   }
}
