...
public class RenderPainting extends Render {
	...
	protected ResourceLocation func_110806_a(EntityPainting par1EntityPainting) {
		return par1EntityPainting.art.special_texture == null ? field_110807_a : par1EntityPainting.art.special_texture;
	}
	...
	private void func_77010_a(EntityPainting par1EntityPainting, int par2, int par3, int par4, int par5) {
		...
		for(int var21 = 0; var21 < par2 / 16; ++var21) {
			for(int var22 = 0; var22 < par3 / 16; ++var22) {
				...
				if (par1EntityPainting.art.special_texture != null) {
					var27 = (float)(par4 + par2 - var21 * 16) / (float)par2;
					var28 = (float)(par4 + par2 - (var21 + 1) * 16) / (float)par2;
					var29 = (float)(par5 + par3 - var22 * 16) / (float)par3;
					var30 = (float)(par5 + par3 - (var22 + 1) * 16) / (float)par3;
				}
				...
				var31.draw();
				this.bindTexture(field_110807_a);
				var31.startDrawingQuads();
				var31.setNormal(0.0F, 0.0F, 1.0F);
