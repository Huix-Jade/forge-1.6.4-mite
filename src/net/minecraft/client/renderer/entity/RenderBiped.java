...
public abstract class RenderBiped extends RenderLiving {
	...
	public static ResourceLocation func_110858_a(ItemArmor par0ItemArmor, int par1, String par2Str) {
		String var3 = String.format("textures/models/armor/%s_layer_%d%s.png", par0ItemArmor.getTextureFilenamePrefix(), par1 == 2 ? 2 : 1, par2Str == null ? "" : String.format("_%s", par2Str));
	...
	protected void func_130005_c(EntityLiving par1EntityLiving, float par2) {
		...
		if (var5 != null) {
			...
			if (var5.getItem().itemID < 256) {
				...
				TileEntitySkullRenderer.skullRenderer.func_82393_a(-0.5F, 0.0F, -0.5F, 1, 180.0F, var5.getItemSubtype(), var7);
			}
