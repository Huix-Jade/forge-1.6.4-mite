...
public class EntityDiggingFX extends EntityFX {
   ...
   public void renderParticle(Tessellator par1Tessellator, float par2, float par3, float par4, float par5, float par6, float par7) {
      if (this.visible_on_tick <= 0L || Minecraft.theMinecraft.theWorld.getTotalWorldTime() >= this.visible_on_tick) {
   ...
   public EntityDiggingFX setVisibleOnTick(long visible_on_tick) {
      this.visible_on_tick = visible_on_tick;
      return this;
   }

   public void onUpdate() {
      if (Minecraft.theMinecraft == null || Minecraft.theMinecraft.theWorld == null || this.visible_on_tick <= 0L || Minecraft.theMinecraft.theWorld.getTotalWorldTime() >= this.visible_on_tick) {
         super.onUpdate();
      }
   }
}
