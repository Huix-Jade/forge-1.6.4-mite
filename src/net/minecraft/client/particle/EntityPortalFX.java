...
public class EntityPortalFX extends EntityFX {
   ...
   public EntityPortalFX(World par1World, double par2, double par4, double par6, double par8, double par10, double par12, int type) {
      ...
      if (type == 1) {
         var14 = (var14 + 1.0F) * 0.5F;
         this.particleRed = 0.03137255F * var14;
         this.particleGreen = 0.4745098F * var14;
         this.particleBlue = 0.6F * var14;
      } else if (type == 2) {
         this.particleRed = 0.74509805F * var14;
         this.particleGreen = 0.14509805F * var14;
         this.particleBlue = 0.043137256F * var14;
      } else {
