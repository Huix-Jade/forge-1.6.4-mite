...
public class ChunkLoader {
   public static AnvilConverterData load(NBTTagCompound par0NBTTagCompound) {
      ...
      var3.blocks = par0NBTTagCompound.getByteArray("BlockData");
      ...
      var3.entities = par0NBTTagCompound.getTagList("EntityData");
      var3.tileEntities = par0NBTTagCompound.getTagList("TileEntityData");
   ...
   public static void convertToAnvilFormat(AnvilConverterData par0AnvilConverterData, NBTTagCompound par1NBTTagCompound, WorldChunkManager par2WorldChunkManager) {
      ...
      for(int var5 = 0; var5 < 8; ++var5) {
         ...
         if (!var6) {
            ...
            NibbleArray var20 = new NibbleArray(var19.length);
            NibbleArray var21 = new NibbleArray(var19.length);
            NibbleArray var23 = new NibbleArray(var19.length);
            ...
            var24.setByteArray("BlockData", var19);
      ...
      par1NBTTagCompound.setTag("EntityData", par0AnvilConverterData.entities);
      par1NBTTagCompound.setTag("TileEntityData", par0AnvilConverterData.tileEntities);
