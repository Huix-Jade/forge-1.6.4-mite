...
public interface IWorldAccess {
   ...
   void playLongDistanceSound(String var1, double var2, double var4, double var6, float var8, float var9);

   void playSoundToNearExcept(EntityPlayer var1, String var2, double var3, double var5, double var7, float var9, float var10);

   void spawnParticle(EnumParticle var1, double var2, double var4, double var6, double var8, double var10, double var12);

   void spawnParticleEx(EnumParticle var1, int var2, int var3, double var4, double var6, double var8, double var10, double var12, double var14);
