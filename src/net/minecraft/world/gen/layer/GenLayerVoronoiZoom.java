...
public class GenLayerVoronoiZoom extends GenLayer {
   ...
   public int[] getInts(int par1, int par2, int par3, int par4, int z) {
      ...
      int[] var11 = this.parent.getInts(var7, var8, var9, var10, z);
      int var12 = var9 << var5;
      ...
      for(int var15 = 0; var15 < var10 - 1; ++var15) {
         ...
         for(int var18 = 0; var18 < var9 - 1; ++var18) {
            double var19 = (double)var6 * 0.9;
            long par1_1 = (long)(var18 + var7 << var5);
            long par3_1 = (long)(var15 + var8 << var5);
            ...
            this.chunkSeed *= this.chunkSeed * 6364136223846793005L + 1442695040888963407L;
            this.chunkSeed += par3_1;
            double var21 = ((double)(this.chunkSeed >> 24 & 1023L) / 1024.0 - 0.5) * var19;
            this.chunkSeed *= this.chunkSeed * 6364136223846793005L + 1442695040888963407L;
            this.chunkSeed += this.worldGenSeed;
            double var23 = ((double)(this.chunkSeed >> 24 & 1023L) / 1024.0 - 0.5) * var19;
            this.chunkSeed *= this.chunkSeed * 6364136223846793005L + 1442695040888963407L;
            this.chunkSeed += this.worldGenSeed;
            par1_1 = (long)(var18 + var7 + 1 << var5);
            par3_1 = (long)(var15 + var8 << var5);
            this.chunkSeed = this.worldGenSeed;
            this.chunkSeed *= this.chunkSeed * 6364136223846793005L + 1442695040888963407L;
            this.chunkSeed += par1_1;
            this.chunkSeed *= this.chunkSeed * 6364136223846793005L + 1442695040888963407L;
            ...
            this.chunkSeed *= this.chunkSeed * 6364136223846793005L + 1442695040888963407L;
            this.chunkSeed += par3_1;
            double var25 = ((double)(this.chunkSeed >> 24 & 1023L) / 1024.0 - 0.5) * var19 + (double)var6;
            this.chunkSeed *= this.chunkSeed * 6364136223846793005L + 1442695040888963407L;
            this.chunkSeed += this.worldGenSeed;
            double var27 = ((double)(this.chunkSeed >> 24 & 1023L) / 1024.0 - 0.5) * var19;
            this.chunkSeed *= this.chunkSeed * 6364136223846793005L + 1442695040888963407L;
            this.chunkSeed += this.worldGenSeed;
            par1_1 = (long)(var18 + var7 << var5);
            par3_1 = (long)(var15 + var8 + 1 << var5);
            this.chunkSeed = this.worldGenSeed;
            this.chunkSeed *= this.chunkSeed * 6364136223846793005L + 1442695040888963407L;
            this.chunkSeed += par1_1;
            this.chunkSeed *= this.chunkSeed * 6364136223846793005L + 1442695040888963407L;
            ...
            this.chunkSeed *= this.chunkSeed * 6364136223846793005L + 1442695040888963407L;
            this.chunkSeed += par3_1;
            double var29 = ((double)(this.chunkSeed >> 24 & 1023L) / 1024.0 - 0.5) * var19;
            this.chunkSeed *= this.chunkSeed * 6364136223846793005L + 1442695040888963407L;
            this.chunkSeed += this.worldGenSeed;
            double var31 = ((double)(this.chunkSeed >> 24 & 1023L) / 1024.0 - 0.5) * var19 + (double)var6;
            this.chunkSeed *= this.chunkSeed * 6364136223846793005L + 1442695040888963407L;
            this.chunkSeed += this.worldGenSeed;
            par1_1 = (long)(var18 + var7 + 1 << var5);
            par3_1 = (long)(var15 + var8 + 1 << var5);
            ...
            this.chunkSeed *= this.chunkSeed * 6364136223846793005L + 1442695040888963407L;
            this.chunkSeed += par3_1;
            double var33 = ((double)(this.chunkSeed >> 24 & 1023L) / 1024.0 - 0.5) * var19 + (double)var6;
            this.chunkSeed *= this.chunkSeed * 6364136223846793005L + 1442695040888963407L;
            this.chunkSeed += this.worldGenSeed;
            double var35 = ((double)(this.chunkSeed >> 24 & 1023L) / 1024.0 - 0.5) * var19 + (double)var6;
            this.chunkSeed *= this.chunkSeed * 6364136223846793005L + 1442695040888963407L;
            this.chunkSeed += this.worldGenSeed;
