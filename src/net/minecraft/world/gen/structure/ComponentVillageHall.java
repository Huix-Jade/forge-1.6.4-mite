...
public class ComponentVillageHall extends ComponentVillage {
   ...
   public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox) {
      ...
      this.placeBlockRelativeWithAdjustedMetadata(par1World, Block.torchWood, 2, 3, 1, 4, par3StructureBoundingBox);
      ...
      this.placeBlockRelativeWithAdjustedMetadata(par1World, Block.torchWood, 6, 3, 4, 3, par3StructureBoundingBox);
