...
public class ComponentVillageTorch extends ComponentVillage {
   ...
   public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox) {
      ...
      this.placeBlockRelativeWithAdjustedMetadata(par1World, Block.torchWood, 0, 3, 0, 2, par3StructureBoundingBox);
      this.placeBlockRelativeWithAdjustedMetadata(par1World, Block.torchWood, 1, 3, 1, 4, par3StructureBoundingBox);
      this.placeBlockRelativeWithAdjustedMetadata(par1World, Block.torchWood, 2, 3, 0, 1, par3StructureBoundingBox);
      this.placeBlockRelativeWithAdjustedMetadata(par1World, Block.torchWood, 1, 3, -1, 3, par3StructureBoundingBox);
      return true;
   }
}
