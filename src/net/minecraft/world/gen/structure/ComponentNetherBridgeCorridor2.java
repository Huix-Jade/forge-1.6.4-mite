   ...
   public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox) {
      ...
      if (this.field_111020_b) {
         ...
         if (par3StructureBoundingBox.isVecInside(var5, var4, var6)) {
            ...
            this.generateStructureChestContents(par1World, par3StructureBoundingBox, par2Random, 1, 2, 3, Block.chest.blockID, field_111019_a, 2 + par2Random.nextInt(4), (float[])null, par2Random.nextInt(2) == 0 ? EnumDirection.SOUTH : EnumDirection.EAST);
         }
      }
