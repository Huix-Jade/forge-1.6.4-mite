...
public class ComponentScatteredFeatureJunglePyramid extends ComponentScatteredFeature {
   ...
   public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox) {
      if (!this.func_74935_a(par1World, par3StructureBoundingBox, 0)) {
         ...
         this.placeBlockRelativeWithAdjustedMetadata(par1World, Block.pistonStickyBase, 9, -2, 8, 1, par3StructureBoundingBox);
         this.placeBlockRelativeWithAdjustedMetadata(par1World, Block.pistonStickyBase, 10, -2, 8, 4, par3StructureBoundingBox);
         this.placeBlockRelativeWithAdjustedMetadata(par1World, Block.pistonStickyBase, 10, -1, 8, 4, par3StructureBoundingBox);
   ...
   static {
      ...
      junglePyramidsDispenserContents = new WeightedRandomChestContent[]{new WeightedRandomChestContent(Item.arrowFlint.itemID, 0, 2, 7, 30)};
      junglePyramidsRandomScatteredStones = new StructureScatteredFeatureStones((ComponentScatteredFeaturePieces2)null);
   }
}
