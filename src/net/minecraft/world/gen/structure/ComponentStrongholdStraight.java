...
public class ComponentStrongholdStraight extends ComponentStronghold {
   ...
   public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox) {
      if (this.isLiquidInStructureBoundingBox(par1World, par3StructureBoundingBox)) {
         ...
         this.placeBlockWithChanceAndDefaultMetadata(par1World, par3StructureBoundingBox, par2Random, 0.1F, 1, 2, 1, Block.torchWood.blockID, false);
         this.placeBlockWithChanceAndDefaultMetadata(par1World, par3StructureBoundingBox, par2Random, 0.1F, 3, 2, 1, Block.torchWood.blockID, false);
         this.placeBlockWithChanceAndDefaultMetadata(par1World, par3StructureBoundingBox, par2Random, 0.1F, 1, 2, 5, Block.torchWood.blockID, false);
         this.placeBlockWithChanceAndDefaultMetadata(par1World, par3StructureBoundingBox, par2Random, 0.1F, 3, 2, 5, Block.torchWood.blockID, false);
         if (this.expandsX) {
