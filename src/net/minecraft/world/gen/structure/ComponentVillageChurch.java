...
public class ComponentVillageChurch extends ComponentVillage {
   ...
   public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox) {
      ...
      this.placeBlockRelativeWithAdjustedMetadata(par1World, Block.torchWood, 2, 4, 7, 3, par3StructureBoundingBox);
      this.placeBlockRelativeWithAdjustedMetadata(par1World, Block.torchWood, 1, 4, 6, 1, par3StructureBoundingBox);
      this.placeBlockRelativeWithAdjustedMetadata(par1World, Block.torchWood, 3, 4, 6, 2, par3StructureBoundingBox);
      this.placeBlockRelativeWithAdjustedMetadata(par1World, Block.torchWood, 2, 4, 5, 4, par3StructureBoundingBox);
