...
public class ComponentMineshaftCorridor extends StructureComponent {
   ...
   protected final boolean generateStructureChestContents(World par1World, StructureBoundingBox par2StructureBoundingBox, Random par3Random, int par4, int par5, int par6, int chest_block_id, WeightedRandomChestContent[] par7ArrayOfWeightedRandomChestContent, int par8) {
      ...
      if (par2StructureBoundingBox.isVecInside(var9, var10, var11) && par1World.getBlockId(var9, var10, var11) == 0) {
         ...
         WeightedRandomChestContent.generateChestContents(par1World, var10, par3Random, par7ArrayOfWeightedRandomChestContent, var12, par8, (float[])null);
   ...
   public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox) {
      if (this.isLiquidInStructureBoundingBox(par1World, par3StructureBoundingBox)) {
         ...
         for(var9 = 0; var9 < this.sectionCount; ++var9) {
            ...
            this.randomlyPlaceBlock(par1World, par3StructureBoundingBox, par2Random, 0.05F, 0, 2, var10 + 2, Block.web.blockID, 0);
            this.randomlyPlaceBlock(par1World, par3StructureBoundingBox, par2Random, 0.05F, 2, 2, var10 + 2, Block.web.blockID, 0);
            if (par1World.getDayOfWorld() >= 10) {
               this.placeBlockWithChanceAndDefaultMetadata(par1World, par3StructureBoundingBox, par2Random, 0.05F, 1, 2, var10 - 1, Block.torchWood.blockID, false);
               this.placeBlockWithChanceAndDefaultMetadata(par1World, par3StructureBoundingBox, par2Random, 0.05F, 1, 2, var10 + 1, Block.torchWood.blockID, false);
            } else {
