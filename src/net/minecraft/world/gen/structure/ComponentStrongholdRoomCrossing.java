      ...
      if (this.isLiquidInStructureBoundingBox(par1World, par3StructureBoundingBox)) {
         ...
         switch (this.roomType) {
            case 0:
               ...
               this.placeBlockRelativeWithAdjustedMetadata(par1World, Block.torchWood, 4, 3, 5, 2, par3StructureBoundingBox);
               this.placeBlockRelativeWithAdjustedMetadata(par1World, Block.torchWood, 6, 3, 5, 1, par3StructureBoundingBox);
               this.placeBlockRelativeWithAdjustedMetadata(par1World, Block.torchWood, 5, 3, 4, 3, par3StructureBoundingBox);
               this.placeBlockRelativeWithAdjustedMetadata(par1World, Block.torchWood, 5, 3, 6, 4, par3StructureBoundingBox);
            ...
            case 2:
               ...
               this.placeBlockRelativeWithDefaultMetadata(par1World, Block.torchWood, 5, 3, 5, par3StructureBoundingBox);
