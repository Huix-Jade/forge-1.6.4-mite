...
public class ForgeEventFactory
{
    ...
    public static float fireBlockHarvesting(ArrayList<ItemStack> drops, BlockBreakInfo blockBreakInfo)
    {
        BlockEvent.HarvestDropsEvent event = new BlockEvent.HarvestDropsEvent
                (blockBreakInfo.x, blockBreakInfo.y, blockBreakInfo.z, blockBreakInfo.world,
                        blockBreakInfo.block, blockBreakInfo.getMetadata(), blockBreakInfo.getHarvesterFortune(), blockBreakInfo.chance, drops,
                        blockBreakInfo.getResponsiblePlayer(), blockBreakInfo.wasSilkHarvested());
        MinecraftForge.EVENT_BUS.post(event);
